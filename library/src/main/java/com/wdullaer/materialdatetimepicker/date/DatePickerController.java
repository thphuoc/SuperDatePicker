...
public interface DatePickerController {
    ...
    Calendar getStartDateSelectable();

    Calendar getEndDateSelectable();

    boolean isOutOfRange(int year, int month, int day);

    void tryVibrate();

    boolean isFirstDayInRange(long timeInMilis);

    boolean isEndDayInRange(long timeInMilis);

    boolean isDayInRange(long timeInMilis);
