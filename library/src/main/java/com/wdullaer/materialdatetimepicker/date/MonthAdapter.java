...
public abstract class MonthAdapter extends BaseAdapter implements OnDayClickListener {
    ...
    @Override
    public int getCount() {
        Calendar endDate = mController.getEndDateSelectable();
        Calendar startDate = mController.getStartDateSelectable();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final int month = (position + mController.getStartDateSelectable().get(Calendar.MONTH)) % MONTHS_IN_YEAR;
        final int year = (position + mController.getStartDateSelectable().get(Calendar.MONTH)) / MONTHS_IN_YEAR + mController.getMinYear();
