...
public abstract class MonthView extends View {
    ...
    public static final String VIEW_PARAM_START_DATE = "start_date";
    public static final String VIEW_PARAM_END_DATE = "end_date";
    ...
    protected Paint mRangeDayPaint;
    ...
    protected long mSelectedLeft = -1;
    // The right edge of the selected day
    protected long mSelectedRight = -1;
    ...
    protected void initView() {
        ...
        mRangeDayPaint = new Paint();
        mRangeDayPaint.setColor(Color.CYAN);
        mRangeDayPaint.setAlpha(50);
    ...
    protected void drawMonthNums(Canvas canvas) {
        ...
        for (int dayNumber = 1; dayNumber <= mNumCells; dayNumber++) {
            ...
            final float startX = (dayWidthHalf * 2 * j);
            final float stopX = startX + dayWidthHalf * 2;
