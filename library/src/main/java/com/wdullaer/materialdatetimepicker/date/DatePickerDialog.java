...
public class DatePickerDialog extends DialogFragment implements
    ...
    private long mStartHighlightFromDate;
    private long mEndSelectToDate;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mRangeDayColor == -1) {
            mRangeDayColor = Utils.getRangeDayColorFromTheme(getActivity());
        }
    ...
    public void setRangeDaySelectedColor(String color) {
        mRangeDayColor = Color.parseColor(color);
    }

    public void setRangeDaySelectedColor(@ColorInt int color) {
        mRangeDayColor = Color.argb(255, Color.red(color), Color.green(color), Color.blue(color));
    }
    ...
    @Override
    public int getRangeDayColor() {
        return mRangeDayColor;
    }
    ...
    @Override
    public Calendar getStartDateSelectable() {
    ...
    @Override
    public Calendar getEndDateSelectable() {
    ...
    public void setHighlightRangeDate(long startDate, long endDate) {
        mStartHighlightFromDate = startDate;
        mEndSelectToDate = endDate;
    }

    @Override
    public boolean isFirstDayInRange(long timeInMilis) {
        ...
        calendar.setTimeInMillis(mStartHighlightFromDate);
        int sYear = calendar.get(Calendar.YEAR);
        int sMonth = calendar.get(Calendar.MONTH);
        int sDay = calendar.get(Calendar.DAY_OF_MONTH);

        return cYear == sYear && cMonth == sMonth && cDay == sDay;
    }

    @Override
    public boolean isEndDayInRange(long timeInMilis) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(timeInMilis);
        int cYear = calendar.get(Calendar.YEAR);
        int cMonth = calendar.get(Calendar.MONTH);
        ...
        calendar.setTimeInMillis(mEndSelectToDate);
        int sYear = calendar.get(Calendar.YEAR);
        int sMonth = calendar.get(Calendar.MONTH);
        int sDay = calendar.get(Calendar.DAY_OF_MONTH);
    ...
    @Override
    public boolean isDayInRange(long timeInMilis) {
        return timeInMilis > mStartHighlightFromDate && timeInMilis < mEndSelectToDate;
    }
}
